...
namespace GloboTicket.TicketManagement.Persistence.Repositories
{
    public class OrderRepository : BaseRepository<Order>, IOrderRepository
    {
        ...
        public async Task<List<Order>> GetPagedOrdersForMonthAsync(DateTimeOffset date, int page, int size)
        {
        ...
        public async Task<int> GetTotalCountOfOrdersForMonthAsync(DateTimeOffset date)
        {
